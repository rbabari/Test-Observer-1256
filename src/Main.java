...
public class Main {
    public static void main(String[] args) {
        ...
        IObservable p2 = new MessagePublisher2();
        ...
        System.out.println("nombre de soubscribers : " + p2.CompterObservers()); // m'attendre 2
        ...
        System.out.println("nombre de soubscribers : " + p2.CompterObservers()); // m'attendre 1
